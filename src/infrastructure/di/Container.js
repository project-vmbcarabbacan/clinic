...
container.register(Types.CONTROLLER.USER, new UserController(container.resolve(Types.USECASE.SIGNUP), container.resolve(Types.USECASE.USER_UPDATE), container.resolve(Types.USECASE.UPDATE_ONE), container.resolve(Types.USECASE.ACHIEVEMENT_ADD), container.resolve(Types.USECASE.ACHIEVEMENT_EDIT)))
